...
public class Position {
    ...
    public void addToTeam(Position newMemb){
        ...
        newMemb.manager = this; // add the manager to be the position it was ran on
        this.team.add(newMemb); // add to the team
    ...
    public void removeFromTeam(Position teamMemb){
          ...
          teamMemb.manager = null;    // clear manager
          this.team.remove(teamMemb); // remove fromt team
